    ...
    return (
        <div className="flex h-screen flex-col items-center justify-between p-24">
            <div className="max-w-5xl items-center text-sm pb-4 md:pb-0">
                <p className="mb-14">
                    A fiber artist and pattern designer&apos;s best friend! The
                ...
                <p className="mb-14">
                    Use our pattern-maker to create a custom grid-based design
                    by hand, or import an existing grid to be converted to a
                    pattern as-is- or customize it to your liking by making
                    changes via the pattern-maker. Once you&apos;re happy with
                    the way your design looks, save it to your account or share
